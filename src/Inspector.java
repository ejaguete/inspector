...
public class Inspector {
	...
	private void printInfo(Class c, Object o) {
	...
	private void inspectHierarchy(Class c, boolean recurse, Object o) {
		if(!c.getName().equals("java.lang.Object") && 
			...
			Class[] supInterfaces = c.getInterfaces();
				...
				try {
					...
					if(fields[i].getType().isArray()) {
						...
						if(!fields[i].getType().getComponentType().toString().contains("java.io")) {
							...
							out.printf(format, "ARRAY CONTENTS", "Cannot display array contents.");
						}
					} 
	...
	public void inspect(Object o, boolean recurse) {
		...
		inspectHierarchy(sup, recurse, o);
